...
public class MetaHolder {
    ...
    public void setHystrixCollapser(HystrixCollapser hystrixCollapser) {
		this.hystrixCollapser = hystrixCollapser;
	}

	public void setHystrixCommand(HystrixCommand hystrixCommand) {
	...
	public void setAjcMethod(Method ajcMethod) {
	...
	public void setDefaultCommandKey(String defaultCommandKey) {
		this.defaultCommandKey = defaultCommandKey;
	}

	public void setDefaultCollapserKey(String defaultCollapserKey) {
		this.defaultCollapserKey = defaultCollapserKey;
	}
	...
	public void setExtendedFallback(boolean extendedFallback) {
		this.extendedFallback = extendedFallback;
	}

	public void setCollapserExecutionType(ExecutionType collapserExecutionType) {
		this.collapserExecutionType = collapserExecutionType;
	}

	public void setFallbackExecutionType(ExecutionType fallbackExecutionType) {
	...
	public void setExtendedParentFallback(boolean extendedParentFallback) {
